...
`Website/` is a working proof of concept for the bottom half of the architecture diagram above (`src/ble` → `src/storage`, roughly). It runs entirely in the browser:
...
<p align="center">
  <sub>KTH Sports Technology · HT26</sub>
</p>
